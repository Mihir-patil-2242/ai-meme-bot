...
def generate_caption(topic):
    ...
    body = {
        ...
        "messages": [
            ...
            {"role": "user", "content": f"Generate ONLY ONE short, funny meme caption about: {topic}. Do NOT return multiple lines, lists, examples, or explanations. Just return one short sentence (max 25 letters) in plain text.No hashtags. No emojis. And funny."}
...
def create_meme_image(caption, uploaded_img, font_path="ComicNeue-Bold.ttf"):
    ...
    draw.rectangle(
    [(0, 0), (img_width, rectangle_height)],
    fill=(0, 0, 0, 180)
    )
